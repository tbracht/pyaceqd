...
from pyaceqd.six_level_system.linear import energies_linear,sixls_linear,sixls_linear_dressed_states
...
t,g,x,y,s,f,b = sixls_linear(-60,3*60,p1, p2,dt=0.1,ae=5.0,verbose=True,phonons=True,delta_b=4.0,bx=2,use_infinite=True)

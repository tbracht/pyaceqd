...
PYBIND11_MODULE(ACE, m) {
  ...
  py::class_<ACE::Parameters>(m, "Parameters")
    ...
    .def(py::init([](const py::list &list){ 
      ...
      }return param;}), py::call_guard<py::gil_scoped_release>())
  ...
  py::class_<ACE::FreePropagator, std::shared_ptr<ACE::FreePropagator> >(m, "FreePropagator")
    ...
    .def("get_dim",&ACE::FreePropagator::get_dim, py::call_guard<py::gil_scoped_release>())
    ...
    .def("add_Hamiltonian",&ACE::FreePropagator::add_Hamiltonian, py::call_guard<py::gil_scoped_release>())
    .def("add_Pulse",static_cast<void (ACE::FreePropagator::*)(const std::pair<std::vector<double>,std::vector<std::complex<double> > > & shape, const Eigen::MatrixXcd &A)>(&ACE::FreePropagator::add_Pulse), py::call_guard<py::gil_scoped_release>())
    ...
    .def("add_Lindblad", [](ACE::FreePropagator &prop, double gamma, const Eigen::MatrixXcd & L){prop.add_Lindblad(gamma, L);}, py::call_guard<py::gil_scoped_release>())
  ...
  py::class_<ACE::ProcessTensorForwardList>(m, "ProcessTensors")
    ...
    .def(py::init([](ACE::Parameters & param){
      return new ACE::ProcessTensorForwardList(param);}), py::call_guard<py::gil_scoped_release>())
...
//    .def(py::init<ACE::Parameters &>())
  ...
  py::class_<ACE::InitialState>(m, "InitialState")
    .def(py::init<>(), py::call_guard<py::gil_scoped_release>())
    .def(py::init<ACE::Parameters &>(), py::call_guard<py::gil_scoped_release>())
    .def(py::init<const Eigen::MatrixXcd &>(), py::call_guard<py::gil_scoped_release>())
    .def_readwrite("rho", &ACE::InitialState::rho, py::call_guard<py::gil_scoped_release>())
    ;
  ...
  py::class_<ACE::TimeGrid>(m, "TimeGrid")
    ...
    .def(py::init([](double ta, double te, double dt){
       ...
       param.add_to("te", te); 
       param.add_to("dt", dt); 
      return new ACE::TimeGrid(param);}), py::call_guard<py::gil_scoped_release>())
    ...
    .def("get_t", &ACE::TimeGrid::get_t, py::call_guard<py::gil_scoped_release>())
    .def("get_all", &ACE::TimeGrid::get_all, py::call_guard<py::gil_scoped_release>())
...
//    .def(py::init<>())
    .def(py::init<ACE::Parameters &>(), py::call_guard<py::gil_scoped_release>())
    .def(py::init<const std::string &, const std::vector<Eigen::MatrixXcd>&>(), py::call_guard<py::gil_scoped_release>())
...
/*    .def(py::init([](ACE::Parameters param){
     ...
     .def("extract",&ACE::OutputPrinter::extract, py::call_guard<py::gil_scoped_release>())
    ;
...
//      ACE::OutputPrinter &printer)>(&ACE::Simulation_PT::run))
  ...
  py::class_<ACE::DynamicalMap>(m, "DynamicalMap")
    .def(py::init<>(), py::call_guard<py::gil_scoped_release>())
    .def(py::init<ACE::Parameters &>(), py::call_guard<py::gil_scoped_release>())
    .def(py::init<ACE::FreePropagator &, ACE::ProcessTensorForwardList &, ACE::Simulation_PT &, const ACE::TimeGrid &>(), py::call_guard<py::gil_scoped_release>())
    .def("calculate", static_cast<void (ACE::DynamicalMap::*)(ACE::Parameters &)>(&ACE::DynamicalMap::calculate), py::call_guard<py::gil_scoped_release>())
    .def("calculate", static_cast<void (ACE::DynamicalMap::*)(ACE::Propagator &, ACE::ProcessTensorForwardList &, ACE::Simulation_PT &, const ACE::TimeGrid &, int)>(&ACE::DynamicalMap::calculate), py::call_guard<py::gil_scoped_release>())
    .def_readwrite("E", &ACE::DynamicalMap::E, py::call_guard<py::gil_scoped_release>())
